...
function showResult() {
    const resultText = `You have answered ${correctAnswers} out of ${totalQuestions} questions correctly.`;
    let detailedResults = '';
    ...
    if (correctAnswers >= 10) { // Update this to the required number of correct answers
        document.getElementById('result').innerHTML = resultText + ' Congratulations! You have passed this test!<br>' + detailedResults;
    } else {
        document.getElementById('result').innerHTML = resultText + ' Sorry! you have not passed this test<br>' + detailedResults;
    }
}
